...
STRINGS = {
    "zh": {
        ...
        "desc.group_summary": "共 {count} 项",
        "desc.group_summary_date": "共 {count} 项，{date}",
        "desc.group_summary_range": "共 {count} 项，{start} ~ {end}",
        # Trash labels
        "trash.label": "废纸篓",
    ...
    "en": {
        ...
        "desc.group_summary": "{count} items",
        "desc.group_summary_date": "{count} items, {date}",
        "desc.group_summary_range": "{count} items, {start} ~ {end}",
        "trash.label": "Trash",
